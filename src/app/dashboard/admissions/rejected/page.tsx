...
function RejectedAdmissionsContent() {
    ...
    <>
      <div className="space-y-8">
        <header className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold tracking-tight">Rejected Applications</h1>
            <p className="text-muted-foreground">A list of all applications that have been rejected.</p>
          </div>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Rejected List</CardTitle>
            <CardDescription>These applications were marked as rejected. No further action is usually needed.</CardDescription>
          </CardHeader>
          <CardContent>
                  ...
                  {loading ? (
                    ...
                    <TableRow>
                      <TableCell colSpan={5} className="h-24 text-center">
                        {firebaseError ? "Could not load data due to configuration error." : "No rejected applications found."}
                      </TableCell>
                    </TableRow>
                  )}
                </TableBody>
...
export default function RejectedAdmissionsPage() {
  return (
    <Suspense fallback={
