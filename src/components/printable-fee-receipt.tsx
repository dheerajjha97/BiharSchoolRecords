...
export const PrintableFeeReceipt = ({ formData, schoolData }: { formData: FormValues; schoolData: School | null }) => {
  ...
  return (
    <div className="a4-container bg-white text-black font-body shadow-lg text-sm">
      <div className="page p-2">
        ...
        <div className="mt-20 grid grid-cols-2 gap-8 text-center text-sm break-inside-avoid">
